...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@stack71"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@devsmja"))
...
💞 مرحبا بك في اوامر سورس ستاك [ @stack71 ]
...
☻ قـائمة جميع اوامر التجميع التي تحتاجها لسورس ستاك 
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('stack71'))
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                ...
                await sython1.send_message(event.chat_id, f"تم الانتهاء من التجميع | ST")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | ST")
...
async def _(event):
    ...
    joinu = await sython1(JoinChannelRequest('ST'))
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                joinu = await sython1(JoinChannelRequest('stack'))
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await sython1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة سورس ستاك**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        await sython1.send_message(event.chat_id, "تم اعادة تشغيل سورس ستاك ")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await sython1(JoinChannelRequest('stack71'))
